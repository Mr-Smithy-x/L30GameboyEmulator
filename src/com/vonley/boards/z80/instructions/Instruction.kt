    ...
    enum class OPS(
        ...
        ADD_HL_BC("ADD HL, BC", 0x09u, 8, flagAffected = "-0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                register.fr.n = false
                register.fr.c = register.hl.checkCarryAddSigned(register.bc)
        ...
        ADD_HL_DE("ADD HL,DE", 0x19u, 8, flagAffected = "-0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.fr.c = register.hl.checkCarryAddSigned(register.de)
                register.hl = value
                return cycles
            }
        },
        ...
        ADD_HL_HL("ADD HL, HL", 0x29u, 8, flagAffected = "-0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.fr.c = register.hl.checkCarryAddSigned(register.hl)
                register.hl = value
                return cycles
            }
        },
        ...
        INC_L("INC L", 0x2Cu, 4, flagAffected = "z0h-") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                register.fr.h = register.l.checkHalfCarryADC(0x1u)
        ...
        ADD_HL_SP("ADD HL, SP", 0x39u, 8, flagAffected = "-0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.fr.c = register.hl.checkCarryAddSigned(register.sp)
                register.hl = value
                return cycles
            }
        },
        ...
        INC_A("INC A", 0x3Cu, 4, flagAffected = "z0h-") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                register.fr.h = register.a.checkHalfCarryADC(0x1u)
        ...
        //TODO: Fix Add, H SET IF CARRY FROM BIT 3, C SET IF CARRY FROM BIT 7
        ADD_A_B("ADD A,B", 0x80u, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                val value = ((register.a + register.b) and 0xFFu).toUByte()
                register.fr.z = value.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarry(register.b)
                register.fr.c = register.a.checkCarryAddSigned(register.b)
                register.a = value
                return cycles
            }
        },
        ADD_A_C("ADD A,C", 0x81u, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                val value = ((register.a + register.c) and 0xFFu).toUByte()
                register.fr.z = value.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarry(register.c)
                register.fr.c = register.a.checkCarryAddSigned(register.c)
                register.a = value
                return cycles
            }
        },
        ADD_A_D("ADD A,D", 0x82u, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                val value = ((register.a + register.d) and 0xFFu).toUByte()
                register.fr.z = value.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarry(register.d)
                register.fr.c = register.a.checkCarryAddSigned(register.d)
                register.a = value
                return cycles
            }
        },
        ADD_A_E("ADD A,E", 0x83u, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                val value = ((register.a + register.e) and 0xFFu).toUByte()
                register.fr.z = value.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarry(register.e)
                register.fr.c = register.a.checkCarryAddSigned(register.e)
                register.a = value
                return cycles
            }
        },
        ADD_A_H("ADD A,H", 0x84u, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                val value = ((register.a + register.h) and 0xFFu).toUByte()
                register.fr.z = value.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarry(register.h)
                register.fr.c = register.a.checkCarryAddSigned(register.h)
                register.a = value
                return cycles
            }
        },
        ADD_A_L("ADD A,L", 0x85u, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                val value = ((register.a + register.l) and 0xFFu).toUByte()
                register.fr.z = value.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarry(register.l)
                register.fr.c = register.a.checkCarryAddSigned(register.l)
                register.a = value
                return cycles
            }
        },
        ADD_A_HL("ADD A,(HL)", 0x86u, 8, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                var hlValue = mmu.readByte(register.hl)
                val value = ((register.a + hlValue) and 0xFFu).toUByte()
                register.fr.z = value.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarry(hlValue)
                register.fr.c = register.a.checkCarryAddSigned(hlValue)
                register.a = value
                return cycles
            }
        },
        ADD_A_A("ADD A,A", 0x87u, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                val value = ((register.a + register.a) and 0xFFu).toUByte()
                register.fr.z = value.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarry(register.a)
                register.fr.c = register.a.checkCarryAddSigned(register.a)
                register.a = value
                return cycles
            }
        },
        ...
        ADC_A_B("ADC A,B", 0x88u, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarryADC(register.b, register.fr.c)
                register.fr.c = register.a.checkCarryADC(register.b, register.fr.c)
                register.a = byteVal
                return cycles
            }
        },
        ADC_A_C("ADC A,C", 0x89u, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.fr.z = byteVal.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarryADC(register.c, register.fr.c)
                register.fr.c = register.a.checkCarryADC(register.c, register.fr.c)
                register.a = byteVal
                return cycles
            }
        },
        ADC_A_D("ADC A,D", 0x8Au, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.fr.z = byteVal.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarryADC(register.d, register.fr.c)
                register.fr.c = register.a.checkCarryADC(register.d, register.fr.c)
                register.a = byteVal
                return cycles
            }
        },
        ADC_A_E("ADC A,E", 0x8Bu, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.fr.z = byteVal.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarryADC(register.e, register.fr.c)
                register.fr.c = register.a.checkCarryADC(register.e, register.fr.c)
                register.a = byteVal
                return cycles
            }
        },
        ADC_A_H("ADC A,H", 0x8Cu, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.fr.z = byteVal.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarryADC(register.h, register.fr.c)
                register.fr.c = register.a.checkCarryADC(register.h, register.fr.c)
                register.a = byteVal
                return cycles
            }
        },
        ADC_A_L("ADC A,L", 0x8Du, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.fr.z = byteVal.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarryADC(register.l, register.fr.c)
                register.fr.c = register.a.checkCarryADC(register.l, register.fr.c)
                register.a = byteVal
                return cycles
            }
        },
        ADC_A_HL("ADC A,(HL)", 0x8Eu, 8, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.fr.z = byteVal.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarryADC(hlByte, register.fr.c)
                register.fr.c = register.a.checkCarryADC(hlByte, register.fr.c)
                register.a = byteVal
                return cycles
            }
        },
        ADC_A_A("ADC A,A", 0x8Fu, 4, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.fr.z = byteVal.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarryADC(register.a, register.fr.c)
                register.fr.c = register.a.checkCarryADC(register.a, register.fr.c)
                register.a = byteVal
                return cycles
            }
        },
        ...
        SUB_A_B("SUB A,B", 0x90u, 4, flagAffected = "z1hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.a = register.a.minus(register.b).and(0xFFu).toUByte()
                return cycles
            }
        },
        SUB_A_C("SUB A,C", 0x91u, 4, flagAffected = "z1hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.a = register.a.minus(register.c).and(0xFFu).toUByte()
                return cycles
            }
        },
        SUB_A_D("SUB A,D", 0x92u, 4, flagAffected = "z1hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.a = register.a.minus(register.d).and(0xFFu).toUByte()
                return cycles
            }
        },
        SUB_A_E("SUB A,E", 0x93u, 4, flagAffected = "z1hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.a = register.a.minus(register.e).and(0xFFu).toUByte()
                return cycles
            }
        },
        SUB_A_H("SUB A,H", 0x94u, 4, flagAffected = "z1hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.a = register.a.minus(register.h).and(0xFFu).toUByte()
                return cycles
            }
        },
        SUB_A_L("SUB A,L", 0x95u, 4, flagAffected = "z1hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.a = register.a.minus(register.l).and(0xFFu).toUByte()
                return cycles
            }
        },
        SUB_A_HL("SUB A,(HL)", 0x96u, 8, flagAffected = "z1hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                val hlAddr = mmu.readByte(register.hl)
                register.fr.z = register.a == hlAddr
                register.fr.n = true
                register.fr.h = register.a.checkHalfCarrySub(hlAddr)
                register.fr.c = register.a.checkCarrySub(hlAddr)
                register.a = register.a.minus(hlAddr).and(0xFFu).toUByte()
                return cycles
            }
        },
        SUB_A_A("SUB A,A", 0x97u, 4, flagAffected = "11hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                register.fr.z = true
                register.fr.n = true
                ...
                register.a = register.a.minus(register.a).and(0xFFu).toUByte()
                return cycles
            }
        },
        ...
        JP_NZ_a16("JP NZ, a16", 0xC2u, 16 / 12, 3u, flagAffected = "----") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                val addressValue = mmu.readShort(register.fetchIncLength(length))
                if (!register.fr.z) {
                    register.pc = addressValue
                    return 16
                }
                return 12
            }
        ...
        JP_a16("JP a16", 0xC3u, 12, 3u, flagAffected = "----") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                var address = mmu.readShort(register.fetchIncLength(length))
                register.pc = address
                return cycles
            }
        },
        CALL_NZ_a16("CALL NZ, a16", 0xC4u, 24 / 12, 3u, flagAffected = "----") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                var addressVal = mmu.readShort(register.fetchIncLength(length))
                if (!register.fr.z) {
                    register.minusSP(0x2u)
                    mmu.writeShort(register.sp, register.pc)
                    register.pc = addressVal
                    return 24
                }
                return 12
            }
        ...
        ADD_A_d8("ADD A, d8", 0xC6u, 8, 2u, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                val d8Byte = mmu.readByte(register.fetchIncLength(length))
                val value = register.a.plus(d8Byte).and(0xFFu).toUByte()
                register.fr.z = value.isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarry(d8Byte)
                register.fr.c = register.a.checkCarryAddSigned(d8Byte)
                register.a = value
                return cycles
            }
        },
        ...
        JP_Z_a16("JP Z, a16", 0xCAu, 16 / 12, 3u, flagAffected = "----") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                val addressVal = mmu.readShort(register.fetchIncLength(length))
                if (register.fr.z) {
                    register.pc = addressVal
                    return 16
                }
        ...
        PREFIX("PREFIX", 0xCBu, 4, flagAffected = "----") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                val byte = mmu.readByte(register.fetchIncLength(length))
                val instruction: UShort = (0xCB00u.toUShort() or byte.toUShort().and(0x00FFu))
                val ops = values().find { f -> f.opcode == instruction }!!
                return ops.execute(mmu, register)
            }
        },
        ...
        ADC_A_d8("ADC A, d8", 0xCEu, 8, 2u, flagAffected = "z0hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                val addressVal = mmu.readByte(register.fetchIncLength(length))
                val value = register.a + addressVal + register.fr.c.asUByte
                register.fr.z = (value and 0xFFu).toUByte().isZero()
                register.fr.n = false
                register.fr.h = register.a.checkHalfCarryADC(addressVal, register.fr.c)
                register.fr.c = register.a.checkCarryADC(addressVal, register.fr.c)
                register.a = (value and 0xFFu).toUByte()
                return cycles
            }
        },
        ...
        SUB_A_d8("SUB A, d8", 0xD6u, 8, 2u, flagAffected = "z1hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                val value = mmu.readByte(register.fetchIncLength(length))
                register.fr.z = register.a == value
                register.fr.n = true
                register.fr.h = register.a.checkHalfCarrySub(value)
                register.fr.c = register.a.checkCarrySub(value)
                register.a = (register.a - value).and(0xFFu).toUByte()
                return cycles
            }
        },
        ...
        SBC_A_d8("SBC A, d8", 0xDEu, 8, 2u, flagAffected = "z1hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                val d8Value = mmu.readByte(register.fetchIncLength(length))
                val value = register.a - d8Value - register.fr.c.asUByte
                var byteValue = (value and 0xFFu).toUByte()
                register.fr.z = byteValue.isZero()
                register.fr.n = true
                register.fr.h = register.a.checkHalfCarrySBC(d8Value, register.fr.c)
                register.fr.c = register.a.checkCarrySBC(d8Value, register.fr.c)
                mmu.writeShort(register.sp, register.de)
                register.a = byteValue
                return cycles
            }
        },
        ...
        LDH_a8_A("LDH (a8), A // LD (FF00+a8), A", 0xE0u, 12, 2u, "----") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                var pcAddress = register.fetchIncLength(length)
                val valueAddress = mmu.readByte(pcAddress).toUShort().and(0x00FFu)
                val realAddress: UShort = (0xFF00u.toUShort() or valueAddress).and(0xFFFFu)
                mmu.writeByte(realAddress, register.a and 0xFFu)
                return cycles
            }
        },
        ...
        LD_Ca_A("LD (C),A", 0xE2u, 8, flagAffected = "----") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.incPC()
                val addr: UShort = (0xFF00u.toUShort() or register.c.toUShort() and 0x00FFu).and(0xFFFFu).toUShort()
                mmu.writeByte(addr, register.a and 0xFFu)
                return cycles
            }
        },
        ...
        AND_A_d8("AND A, d8", 0xE6u, 8, 2u, flagAffected = "z010") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.a = register.a.and(mmu.readByte(register.fetchIncLength(length)))
                register.fr.z = register.a.isZero()
                register.fr.n = false
                register.fr.h = true
                register.fr.c = false
        ...
        ADD_SP_r8("ADD SP, r8", 0xE8u, 16, 2u, flagAffected = "00hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                ...
                register.fr.z = false
                register.fr.n = false
                register.fr.h = register.sp.checkHalfCarryAddSigned(value)
                register.fr.c = register.sp.checkCarryAddSigned(value)
                register.sp = value.jump(register.sp)
                return cycles
            }
        },
        ...
        LD_a16_A("LD (a16),A", 0xEAu, 16, 3u, "----") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                mmu.writeByte(mmu.readShort(register.fetchIncLength(length)), register.a)
                return cycles
            }
        },
        XOR_A_d8("XOR A, d8", 0xEEu, 8, 2u, flagAffected = "z000") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.a = register.a.xor(mmu.readByte(register.fetchIncLength(length)))
                register.fr.z = register.a.isZero()
                register.fr.n = false
                register.fr.h = false
                register.fr.c = false
        ...
        LDH_A_a8("LDH A,(a8) // LD A,(FF00+n)", 0xF0u, 12, 2u, "----") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                val byte = mmu.readByte(register.fetchIncLength(length))
                val value = 0xFF00u.toUShort() or byte.toUShort().and(0x00FFu)
                register.a = mmu.readByte(value)
                return cycles
            }
        },
        ...
        LD_A_Ca("LD A,(C)", 0xF2u, 8, flagAffected = "----") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                var address = 0xFF00u.toUShort() or register.c.toUShort().and(0x00FFu)
                register.a = mmu.readByte(address)
                return cycles
            }
        },
        ...
        OR_A_d8("OR A, d8", 0xF6u, 8, 2u, flagAffected = "z000") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.a = register.a or mmu.readByte(register.fetchIncLength(length))
                register.fr.z = register.a.isZero()
                register.fr.n = false
                register.fr.h = false
                register.fr.c = false
        ...
        LDHL_SP_r8("LD HL,SP+r8", 0xF8u, 12, 2u, "00hc") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                val value = mmu.readByte(register.fetchIncLength(length))
                register.hl = value.jump(register.sp)
                register.fr.z = false
                register.fr.n = false
                register.fr.h = register.sp.checkHalfCarryAddSigned(value)
                register.fr.c = register.sp.checkCarryAddSigned(value)
        ...
        LD_A_a16("LD A,a16", 0xFAu, 16, 3u, "----") {
            override fun execute(mmu: MMU, register: CPURegister): Int {
                register.a = mmu.readByte(mmu.readShort(register.fetchIncLength(length)))
                return cycles
            }
        },
